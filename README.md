...
| `lpc_NB_METHOD_generalized_final`  | `.R`   | Workflow used on computing cluster to conduct competing methods (scDD, muscat, Wilcoxon from Seurat, MAST) in empirical FDR test |
| `NB_SHIFT_comparison_final`  | `.R`   | Workflow used to run pseudobulk comparison in simulated shift type |
